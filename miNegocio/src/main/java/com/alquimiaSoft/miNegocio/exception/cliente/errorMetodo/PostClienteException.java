...
public class PostClienteException extends CustomException {

    public PostClienteException(Throwable throwable){
        super(throwable);
    }

    @Override
    public String getCode(){
        return ExceptionCode.CODE_05;
    }

    @Override
    public String getDescription(){
        return ExceptionCode.MESSAGE_05;
    }
