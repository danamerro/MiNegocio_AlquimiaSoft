...
public class MissingClienteByNombreAndNumeroIdentificacionException extends CustomNotFoundException {

    @Override
    public String getCode(){
        return ExceptionCode.CODE_03;
    }

    @Override
    public String getDescription(){
        return ExceptionCode.MESSAGE_03;
    }
}
